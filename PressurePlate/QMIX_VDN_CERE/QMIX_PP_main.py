...
class Runner_QMIX_PP:
    def __init__(self, args, env_name, number, seed):
        ...
        # Create N agents
        self.agent_n = QMIX_PP(self.args)
    ...
    def evaluate_policy(self, evaluate_num):
        ...
        print("total_steps:{} \t win_rate:{} \t evaluate_reward:{} \t evaluate_episode_length:{}".format(self.total_steps, win_rate, evaluate_reward, evaluate_episode_length))
    ...
    def run_episode(self, evaluate=False):
        ...
        for episode_step in range(self.args.episode_limit):
            ...
            self.agent_n.ts.update_prob_pp(env_info['rewards'], a_n)
            episode_reward += r

            if not evaluate:
                ir = self.agent_n.get_intrinsic_reward(np.concatenate(all_obs, 0), all_obs,
