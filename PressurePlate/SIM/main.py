...
from SIM.parameters.parameters import Parameters_PP6P
from run import run
...
def main():
    ...
    # env_name = [parameters.Parameters_PP4P,parameters.Parameters_PP5P,parameters.Parameters_PP6P]
    env_name = [parameters.Parameters_PP4P]
    ...
    for env in env_name:
        ...
        for run_number in range(params.RUNS):
            ...
            # set liner-4p-d
            params.ENV_ARGS['random_position'] = True
