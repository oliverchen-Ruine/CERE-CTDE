...
class PressurePlateWrapper(MultiAgentEnv):
    def __init__(self, **kwargs):
        ...
        self.action_space = 5
        self.steps = 0
        self.options = {"random_position": args["random_position"]}
