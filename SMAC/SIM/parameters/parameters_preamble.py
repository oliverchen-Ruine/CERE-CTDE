...
from .algs.expqmix import EXPQMIX
from .algs.qtran import QTRAN
from .algs.expqtran import EXPQTRAN
from .algs.qplex import QPLEX
from .algs.expqplex import EXPQPLEX
from .algs.matd3 import MATD3
from .algs.expmatd3 import EXPMATD3
from .algs.cw_qmix import CWQMIX
from .algs.expcw_qmix import EXPCWQMIX
from .algs.ow_qmix import OWQMIX
from .algs.expow_qmix import EXPOWQMIX
from .algs.semi_emc_qmix import SEMIEMCQMIX
from .algs.rnd_qmix import RNDQMIX
from .algs.icm_qmix import ICMQMIX
from .algs.noise_qmix import NOISEQMIX as MAVEN

from .envs.payoff_matrix import PayoffMatrix64Step, PayoffMatrix128Step, PayoffMatrix256Step
from .envs.sc2 import SC2_3m, SC2_27m_vs_30m, SC2_3s_vs_5z, SC2_3s5z, SC2_2c_vs_64zg, SC2_MMM, SC2_Corridor, SC2_6h_vs_8z, SC2_5m_vs_6m, SC2_MMM2, SC2_3s5z_vs_3s6z, SC2_2s_vs_1sc, SC2_2s3z, SC2_8m, SC2_so_many_baneling, SC2_10m_vs_11m, SC2_2_corridors
from .envs.ma_mujoco import MaMujoco2AAnt, MaMujoco4AAnt, MaMujoco2AHalfcheetah, MaMujoco6AHalfcheetah, MaMujoco3AHopper, MaMujoco2AHumanoid, MaMujoco2AHumanoidStandup, MaMujocoManyAgentSwimmer, MaMujocoCoupledHalfCheetah, MaMujocoManyAgentAnt
from .envs.pettingzoo import PettingZooPistonBall, PettingZooCooperativePong, PettingZooSimpleSpread, PettingZooPursuit
from .envs.pressureplate import PressurePlateLinear4P, PressurePlateLinear5P, PressurePlateLinear6P
from .envs.rwarehouse import RWarehouseTiny2Ag, RWarehouseSmall4Ag, RWarehouseHard6Ag
...
class ExpQmixSc2_2_corridors(SC2_2_corridors, EXPQMIX, General):
    param_overlapped_dict = check_parameters_overlapped(General, EXPQMIX, SC2_2_corridors)
