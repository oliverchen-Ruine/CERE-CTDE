...
class Logger:
    ...
    def set_wandb(self, args):
        ...
        # else:
        #     self.wandb = None
        os.environ["WANDB_API_KEY"] = '068af2a5f3db2d766e0998cbd87ca3d6264c47cc'
    ...
    def setup_tb(self, directory_name):
        # 检查是否有默认 logger 并清理
        if tb_logger.tensorboard_logger._default_logger is not None:
              tb_logger.tensorboard_logger._default_logger = None # 强制删除全局 logger
